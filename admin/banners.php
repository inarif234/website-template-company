                            ...
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody class="divide-y divide-slate-800/60 text-sm">
                                    ...
                                    <tr class="hover:bg-slate-800/30 transition-colors">
                                        <td class="p-4">
                                            <img src="../<?= htmlspecialchars($b['image_desktop']) ?>" class="w-16 h-10 object-cover rounded-lg shadow border border-slate-700/50" onerror="this.src='../public/assets/logo/logo.png'">
                                        </td>
